    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="relative w-full aspect-video bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div
            className={`bg-pink-600/80 px-6 py-3 rounded-full text-2xl font-bold transform transition-all duration-300 ${encouragement ? "scale-100 opacity-100" : "scale-90 opacity-0"}`}
          >
            {encouragement}
          </div>
        </div>
        ...
        {/* Timer */}
        <div className="absolute top-2 right-2 bg-black/70 px-3 py-1 rounded-full text-sm">{timeRemaining}s</div>
      </div>
      ...
      <div className="flex-1 flex items-stretch p-4 gap-4">
        ...
        <div className="flex-1 flex flex-col items-center">
          <div className="mb-2 flex items-center">
            ...
            {peakPlayerVolume > peakOpponentVolume && <Crown className="w-5 h-5 text-yellow-400" />}
          </div>
          ...
          <div className="mt-2 text-lg font-bold">{Math.round(peakPlayerVolume)}</div>
        </div>
